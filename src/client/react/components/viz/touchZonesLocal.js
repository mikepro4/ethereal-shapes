...
import {
    createShape, loadShape, searchShapes, deleteShape, loadNewShape, clearNewShape, getMainShape
...
class TouchZones extends Component {
    ...
    startZone5TimeInterval() {
        ...
        let selectedShape = this.props.shape
                ...
                let finalshape = {
                    ...
                    defaultViz: {
                        ...
                        shape: {
                            ...
                            boldRate: selectedShape.defaultViz.shape.boldRate + this.state.time / 1000
                        }
                    }
                }
            ...
            if (selectedShape && selectedShape.defaultViz) {
                let finalshape = {
                    ...
                    defaultViz: {
                        ...
                        shape: {
                            ...selectedShape.defaultViz.shape,
                            step: selectedShape.defaultViz.shape.step + this.state.time / 100000
                        }
                    }
                }
                this.updateShape(finalshape)
            ...
            if (selectedShape && selectedShape.defaultViz) {
                let finalshape = {
                    ...
                    defaultViz: {
                        ...
                        shape: {
                            ...selectedShape.defaultViz.shape,
                            frequency: selectedShape.defaultViz.shape.frequency + this.state.time / 10000
                        }
                    }
                }
                this.updateShape(finalshape)
            ...
            if (selectedShape && selectedShape.defaultViz) {
                let finalshape = {
                    ...
                    defaultViz: {
                        ...
                        shape: {
                            ...selectedShape.defaultViz.shape,
                            rotateSpeed: selectedShape.defaultViz.shape.rotateSpeed + this.state.time / 1000
                        }
                    }
                }
                this.updateShape(finalshape)
    ...
    updateShape = (finalShape) => {
       this.props.updateShape(finalShape)
    }
